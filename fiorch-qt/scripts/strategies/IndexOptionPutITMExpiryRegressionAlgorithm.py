...
#
# Strategy ID: FCT-48BF5359
# Category: Options
# Description: This regression algorithm tests In The Money (ITM) index option expiry for puts. We expect 2 orders from the algorith...
