#!/usr/bin/env python3
"""
Financial Orchestrator - Live Strategy Runner
    ...
    try:
        ...
        for name, obj in module_globals.items():
            if isinstance(obj, type) and name != "QCAlgorithm":
                try:
                    from fiorch_engine.algorithm import QCAlgorithm
    ...
    try:
        while running:
            try:
                ...
                try:
                    from fiorch_engine.types import TradeBar, Symbol as FSymbol, Slice
                    from fiorch_engine.enums import SecurityType, Market as FMarket
...
def _fetch_price(symbol: str, asset_type: str, app_db_path: str = ""):
    ...
    main fiorch_terminal.db. This function reads from that table so strategies
