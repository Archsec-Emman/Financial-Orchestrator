...
#
# Strategy ID: FCT-A4B98519
# Category: General Strategy
# Description: Algorithm illustrating how to manually set market hours and symbol properties database entries to be picked up by the...
