...
#
# Strategy ID: FCT-B4342086
# Category: Options
# Description: This regression algorithm tests Out of The Money (OTM) future option expiry for calls. We expect 2 orders from the al...
