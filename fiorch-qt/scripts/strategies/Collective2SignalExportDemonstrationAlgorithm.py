...
#
# Strategy ID: FCT-8AEECDC1
# Category: General Strategy
# Description: This algorithm sends a list of portfolio targets to Collective2 API every time the ema indicators crosses between the...
