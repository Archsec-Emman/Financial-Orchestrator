...
#
# Strategy ID: FCT-B97EAA99
# Category: ETF
# Description: Tests the mapping of the ETF symbol that has a constituent universe attached to it and ensures that data is loaded af...
