...
#
# Strategy ID: FCT-52E3A84A
# Category: Regression Test
# Description: Regression algorithm illustrating how to request history data for continuous contracts with different depth offsets
