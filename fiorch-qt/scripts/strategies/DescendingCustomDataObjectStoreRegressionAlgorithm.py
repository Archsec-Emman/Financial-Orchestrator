...
#
# Strategy ID: FCT-6513B96C
# Category: Regression Test
# Description: The regression algorithm showcases the utilization of a custom data source with the Sort flag set to true. This means...
