...
#
# Strategy ID: FCT-DAAB71C9
# Category: General Strategy
# Description: Algorithm demonstrating custom charting support in QuantConnect. The entire charting system of quantconnect is adapta...
