...
#
# Strategy ID: FCT-B0B2E65B
# Category: General Strategy
# Description: Demonstration of how to use custom security properties. In this algorithm we trade a security based on the values of ...
