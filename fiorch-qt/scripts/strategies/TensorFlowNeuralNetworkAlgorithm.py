...
#
# Strategy ID: FCT-42FC8E69
# Category: Machine Learning
# Description: Enter or exit positions based on relationship of the open price of the current bar and the prices defined by the mach...
