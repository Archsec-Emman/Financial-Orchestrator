...
#
# Strategy ID: FCT-5600B07D
# Category: Portfolio Management
# Description: This algorithm sends a list of portfolio targets from algorithm's Portfolio to Collective2 API every time the ema ind...
