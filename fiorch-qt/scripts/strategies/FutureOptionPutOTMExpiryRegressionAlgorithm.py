...
#
# Strategy ID: FCT-ADF65A2F
# Category: Options
# Description: This regression algorithm tests Out of The Money (OTM) future option expiry for puts. We expect 2 orders from the alg...
