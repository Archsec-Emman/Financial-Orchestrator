...
#
# Strategy ID: FCT-8C140F85
# Category: Custom Data
# Description: This demonstration imports indian NSE index "NIFTY" as a tradable security in addition to the USDINR currency pair. W...
