...
#
# Strategy ID: FCT-300B9FC2
# Category: Options
# Description: This regression algorithm tests In The Money (ITM) index option expiry for short calls. We expect 2 orders from the a...
