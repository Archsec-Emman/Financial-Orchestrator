...
#
# Strategy ID: FCT-F09974A0
# Category: Futures
# Description: Minute resolution regression algorithm trading Coin and USDT binance futures long and short asserting the behavior
