...
#
# Strategy ID: FCT-DE2ACA2C
# Category: Options
# Description: This regression algorithm tests In The Money (ITM) future option expiry for calls. We expect 3 orders from the algori...
