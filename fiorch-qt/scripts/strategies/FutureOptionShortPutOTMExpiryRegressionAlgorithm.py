...
#
# Strategy ID: FCT-470C1BB3
# Category: Options
# Description: This regression algorithm tests Out of The Money (OTM) future option expiry for short puts. We expect 2 orders from t...
