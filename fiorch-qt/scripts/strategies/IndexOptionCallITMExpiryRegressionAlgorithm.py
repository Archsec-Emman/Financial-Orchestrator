...
#
# Strategy ID: FCT-EA1D90BB
# Category: Options
# Description: This regression algorithm tests In The Money (ITM) index option expiry for calls. We expect 2 orders from the algorit...
