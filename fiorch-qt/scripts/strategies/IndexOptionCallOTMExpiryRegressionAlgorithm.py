...
#
# Strategy ID: FCT-6AE00A81
# Category: Options
# Description: This regression algorithm tests Out of The Money (OTM) index option expiry for calls. We expect 2 orders from the alg...
