...
def get_data_dir():
    ...
    fiorch_dir = os.environ.get("FINCEPT_DATA_DIR", "")
    if fiorch_dir:
        return os.path.join(fiorch_dir, "vision_quant")
    # Fallback: ~/.fiorch/vision_quant
    home = os.path.expanduser("~")
    return os.path.join(home, ".fiorch", "vision_quant")
