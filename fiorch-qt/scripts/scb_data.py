...
POPULAR_TABLES = {
    ...
    "gdp": {
        "id": "NR/NR0103/NR0103A/NR0103ENS2010T01Kv",
        "name": "GDP by quarter",
...
class SCBDataAPI:
    ...
    def get_gdp_data(self, quarters: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            query = [
                {
                    ...
                    "selection": {
                        "filter": "item",
                        "values": ["BNPM"]  # GDP at market prices
                    }
                },
                {
                    "code": "ContentsCode",
                    "selection": {
                        "filter": "item",
                        "values": ["NR0103BV"]  # Current prices, million SEK
                    }
                },
                {
                    "code": "Tid",
            ...
            result = self.get_table_data("NR/NR0103/NR0103A/NR0103ENS2010T01Kv", query)

            if result.get("success"):
                result["data"]["description"] = "Swedish GDP by quarter (current prices, million SEK)"
