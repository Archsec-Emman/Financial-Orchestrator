"""
Financial Orchestrator - Python Output Standardization Library
=========================================================

This library provides a standard output format for all Python scripts in the Financial Orchestrator.
...
Usage:
    from fiorch_output_standard import standardize_output, OutputType
