...
RESEARCH_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a financial research specialist for Financial Orchestrator. "
...
DATA_ANALYST_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a quantitative data analyst for Financial Orchestrator. "
...
TRADING_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a trading strategy specialist for Financial Orchestrator. "
...
RISK_ANALYZER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a risk management specialist for Financial Orchestrator. "
...
PORTFOLIO_OPTIMIZER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a portfolio optimization specialist for Financial Orchestrator. "
...
BACKTESTER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a backtesting specialist for Financial Orchestrator. "
...
REPORTER_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a financial report writer for Financial Orchestrator. "
...
MACRO_ECONOMIST_AGENT: dict[str, Any] = {
    ...
    "system_prompt": (
        "You are a macroeconomic analyst for Financial Orchestrator. "
