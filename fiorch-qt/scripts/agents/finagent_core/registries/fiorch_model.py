...
_RATE_LOCK_FILE = os.path.join(tempfile.gettempdir(), "fiorch_llm_rate.lock")
_RATE_TS_FILE   = os.path.join(tempfile.gettempdir(), "fiorch_llm_rate.ts")
_fiorch_proc_lock = threading.Lock()  # within-process serialisation

def _rate_limit_fiorch() -> None:
    """
...
FINCEPT_DEFAULT_URL = "https://api.fiorch.in/research/llm"
...
@dataclass
    ...
    def _call_endpoint(
        ...
        try:
            ...
            _rate_limit_fiorch()  # honour rate limit before fallback attempt
