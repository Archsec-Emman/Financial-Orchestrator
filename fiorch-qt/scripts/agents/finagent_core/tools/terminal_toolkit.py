"""
TerminalToolkit - Agno Toolkit that proxies calls to Financial Orchestrator internal MCP tools.
...
class TerminalToolkit:
    """
    Agno-compatible toolkit that wraps Financial Orchestrator's internal MCP tools.
