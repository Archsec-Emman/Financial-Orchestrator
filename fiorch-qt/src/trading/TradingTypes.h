...
#include <QMetaType>
Q_DECLARE_METATYPE(fiorch::trading::BrokerPosition)
Q_DECLARE_METATYPE(fiorch::trading::BrokerHolding)
Q_DECLARE_METATYPE(fiorch::trading::BrokerOrderInfo)
Q_DECLARE_METATYPE(fiorch::trading::BrokerQuote)
Q_DECLARE_METATYPE(fiorch::trading::BrokerFunds)
Q_DECLARE_METATYPE(QVector<fiorch::trading::BrokerPosition>)
Q_DECLARE_METATYPE(QVector<fiorch::trading::BrokerHolding>)
Q_DECLARE_METATYPE(QVector<fiorch::trading::BrokerOrderInfo>)
Q_DECLARE_METATYPE(QVector<fiorch::trading::BrokerQuote>)
