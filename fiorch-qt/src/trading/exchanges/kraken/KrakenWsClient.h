...
class KrakenWsClient : public QObject {
  ...
  signals:
    void ticker_received(const fiorch::trading::TickerData& ticker);
    void orderbook_received(const fiorch::trading::OrderBookData& orderbook);
    void trade_received(const fiorch::trading::TradeData& trade);
    void candle_received(const QString& symbol, const QString& interval,
                         const fiorch::trading::Candle& candle);
  ...
  private:
    ...
    fiorch::WebSocketClient* ws_ = nullptr;
