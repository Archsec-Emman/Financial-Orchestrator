...
namespace fiorch::trading::kraken {
...
KrakenWsClient::KrakenWsClient(QObject* parent) : QObject(parent) {
    ...
    connect(ws_, &fiorch::WebSocketClient::connected, this, &KrakenWsClient::on_ws_connected);
    connect(ws_, &fiorch::WebSocketClient::disconnected, this, &KrakenWsClient::on_ws_disconnected);
    connect(ws_, &fiorch::WebSocketClient::message_received, this, &KrakenWsClient::on_ws_message);
    connect(ws_, &fiorch::WebSocketClient::error_occurred, this, &KrakenWsClient::on_ws_error);
