...
fiorch::Result<void> InstrumentRepository::replace_all(const QString& broker_id,
    ...
    return fiorch::Result<void>::ok();
}

fiorch::Result<void> InstrumentRepository::clear(const QString& broker_id) {
