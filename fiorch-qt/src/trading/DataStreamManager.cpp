...
void DataStreamManager::ensure_registered_with_hub() {
    ...
    fiorch::datahub::TopicPolicy positions_policy;
    ...
    fiorch::datahub::TopicPolicy orders_policy;
    ...
    fiorch::datahub::TopicPolicy balance_policy;
    ...
    fiorch::datahub::TopicPolicy ticks_policy;
    ...
    fiorch::datahub::TopicPolicy holdings_policy;
    ...
    fiorch::datahub::TopicPolicy quote_policy;
...
void DataStreamManager::on_positions_for_hub(const QString& account_id,
    ...
    fiorch::datahub::DataHub::instance().publish(topic, QVariant::fromValue(positions));
}
...
void DataStreamManager::on_holdings_for_hub(const QString& account_id,
    ...
    fiorch::datahub::DataHub::instance().publish(topic, QVariant::fromValue(holdings));
}
...
void DataStreamManager::on_orders_for_hub(const QString& account_id,
    ...
    fiorch::datahub::DataHub::instance().publish(topic, QVariant::fromValue(orders));
}
...
void DataStreamManager::on_funds_for_hub(const QString& account_id, const BrokerFunds& funds) {
    ...
    fiorch::datahub::DataHub::instance().publish(topic, QVariant::fromValue(funds));
}
...
void DataStreamManager::on_quote_for_hub(const QString& account_id, const QString& symbol,
    ...
    fiorch::datahub::DataHub::instance().publish(topic, QVariant::fromValue(quote));
}
