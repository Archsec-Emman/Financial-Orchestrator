...
void DebugOverlay::refresh() {
    ...
    const int total_panels = fiorch::PanelRegistry::instance().size();
    ...
    int topic_count = 0;
    {
        const auto stats = fiorch::datahub::DataHub::instance().stats();
