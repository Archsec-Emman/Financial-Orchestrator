...
class NotifToast : public QWidget {
  ...
  public slots:
    void show_notification(const fiorch::notifications::NotificationRecord& record);
  ...
  private:
    ...
    fiorch::notifications::NotifLevel current_level_{fiorch::notifications::NotifLevel::Info};
