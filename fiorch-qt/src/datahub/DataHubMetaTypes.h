...
Q_DECLARE_METATYPE(fiorch::services::QuoteData)
Q_DECLARE_METATYPE(fiorch::services::HistoryPoint)
Q_DECLARE_METATYPE(fiorch::services::InfoData)
Q_DECLARE_METATYPE(QVector<fiorch::services::HistoryPoint>)
Q_DECLARE_METATYPE(fiorch::trading::TickerData)
Q_DECLARE_METATYPE(fiorch::trading::OrderBookData)
Q_DECLARE_METATYPE(fiorch::trading::Candle)
Q_DECLARE_METATYPE(fiorch::trading::TradeData)
