...
void WindowFrame::on_auth_state_changed() {
    ...
    if (auth.is_authenticated()) {
        ...
        if (auth.session().has_paid_plan()) {
            ...
            fiorch::trading::InstrumentService::instance().load_from_db_async("zerodha");
            fiorch::trading::InstrumentService::instance().load_from_db_async("angelone");
            fiorch::trading::InstrumentService::instance().load_from_db_async("groww");
        } else {
