...
QString DockScreenRouter::title_for_id(const QString& id) {
    ...
    static const QHash<QString, const char*> titles = {
        {"dashboard", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Dashboard")},
        {"markets", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Markets")},
        {"crypto_trading", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Crypto Trading")},
        {"equity_trading", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Equity Trading")},
        {"algo_trading", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Algo Trading")},
        {"backtesting", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Backtesting")},
        {"portfolio", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Portfolio")},
        {"watchlist", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Watchlist")},
        {"news", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "News")},
        {"ai_chat", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "AI Chat")},
        {"equity_research", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Equity Research")},
        {"economics", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Economics")},
        {"dbnomics", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "DBnomics")},
        {"akshare", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "AkShare Data")},
        {"asia_markets", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Asia Markets")},
        {"geopolitics", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Geopolitics")},
        {"gov_data", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Gov Data")},
        {"maritime", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Maritime")},
        {"polymarket", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Prediction Markets")},
        {"relationship_map", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Relationship Map")},
        {"derivatives", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Derivatives")},
        {"alt_investments", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Alt Investments")},
        {"ma_analytics", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "M&A Analytics")},
        {"surface_analytics", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Surface Analytics")},
        {"quantlib", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "QuantLib")},
        {"ai_quant_lab", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "AI Quant Lab")},
        {"alpha_arena", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Alpha Arena")},
        {"agent_config", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Agent Config")},
        {"mcp_servers", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "MCP Servers")},
        {"node_editor", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Node Editor")},
        {"code_editor", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Code Editor")},
        {"excel", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Excel")},
        {"report_builder", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Report Builder")},
        {"trade_viz", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Trade Viz")},
        {"data_sources", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Data Sources")},
        {"data_mapping", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Data Mapping")},
        {"file_manager", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "File Manager")},
        {"notes", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Notes")},
        {"forum", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Forum")},
        {"docs", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Docs")},
        {"support", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Support")},
        {"about", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "About")},
        {"profile", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Profile")},
        {"settings", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Settings")},
        {"contact", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Contact")},
        {"terms", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Terms")},
        {"privacy", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Privacy")},
        {"trademarks", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Trademarks")},
        {"help", QT_TRANSLATE_NOOP("fiorch::DockScreenRouter", "Help")},
    };
    auto it = titles.find(id);
    if (it == titles.end())
        return id;
    return QCoreApplication::translate("fiorch::DockScreenRouter", it.value());
}
