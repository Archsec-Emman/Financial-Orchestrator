...
struct OptionChainRow {
    ...
    fiorch::trading::BrokerQuote ce_quote;
    fiorch::trading::BrokerQuote pe_quote;
...
struct StrategyLeg {
    ...
    fiorch::trading::InstrumentType type = fiorch::trading::InstrumentType::UNKNOWN;
    double  strike = 0;
    QString expiry;
    int     lot_size = 0;
...
Q_DECLARE_METATYPE(fiorch::services::options::OptionGreeks)
Q_DECLARE_METATYPE(fiorch::services::options::OptionChainRow)
Q_DECLARE_METATYPE(fiorch::services::options::OptionChain)
Q_DECLARE_METATYPE(fiorch::services::options::StrategyLeg)
Q_DECLARE_METATYPE(fiorch::services::options::Strategy)
Q_DECLARE_METATYPE(fiorch::services::options::PayoffPoint)
Q_DECLARE_METATYPE(fiorch::services::options::StrategyAnalytics)
Q_DECLARE_METATYPE(fiorch::services::options::OISample)
Q_DECLARE_METATYPE(QVector<fiorch::services::options::OptionChainRow>)
Q_DECLARE_METATYPE(QVector<fiorch::services::options::PayoffPoint>)
Q_DECLARE_METATYPE(QVector<fiorch::services::options::StrategyLeg>)
Q_DECLARE_METATYPE(QVector<fiorch::services::options::OISample>)
