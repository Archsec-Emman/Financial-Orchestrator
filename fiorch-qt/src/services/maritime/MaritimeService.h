...
/// Singleton service for Maritime Intelligence — HTTP calls to api.fiorch.in/marine/
    ...
    , public fiorch::datahub::Producer
{
  ...
  signals:
    ...
    void vessels_loaded(fiorch::services::maritime::VesselsPage page);
    void vessel_found(fiorch::services::maritime::VesselData vessel);
    void vessel_history_loaded(fiorch::services::maritime::VesselHistoryPage page);
