...
namespace fiorch::services::maritime {
...
static constexpr const char* kMarineBase = "https://api.fiorch.in/marine";
...
void MaritimeService::search_vessels_by_area(const AreaSearchParams& params) {
    ...
    const QString cache_key = QString("maritime:area:%1:%2:%3:%4:%5")
                                  ...
                                  .arg(params.days_ago);
    const QVariant cached = fiorch::CacheManager::instance().get(cache_key);
    if (!cached.isNull()) {
...
void MaritimeService::ensure_registered_with_hub() {
    ...
    fiorch::datahub::TopicPolicy vessel_policy;
    ...
    // History: 5 min TTL.
    fiorch::datahub::TopicPolicy history_policy;
    ...
    fiorch::datahub::TopicPolicy health_policy;
