...
#include <QMetaType>
Q_DECLARE_METATYPE(fiorch::services::maritime::VesselData)
Q_DECLARE_METATYPE(fiorch::services::maritime::VesselsPage)
Q_DECLARE_METATYPE(fiorch::services::maritime::VesselHistoryPage)
Q_DECLARE_METATYPE(QVector<fiorch::services::maritime::VesselData>)
