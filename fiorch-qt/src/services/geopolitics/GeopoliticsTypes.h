...
#include <QMetaType>
Q_DECLARE_METATYPE(fiorch::services::geo::NewsEvent)
Q_DECLARE_METATYPE(fiorch::services::geo::HDXDataset)
Q_DECLARE_METATYPE(fiorch::services::geo::UniqueCountry)
Q_DECLARE_METATYPE(fiorch::services::geo::UniqueCategory)
Q_DECLARE_METATYPE(fiorch::services::geo::EventsPage)
Q_DECLARE_METATYPE(QVector<fiorch::services::geo::NewsEvent>)
Q_DECLARE_METATYPE(QVector<fiorch::services::geo::HDXDataset>)
Q_DECLARE_METATYPE(QVector<fiorch::services::geo::UniqueCountry>)
Q_DECLARE_METATYPE(QVector<fiorch::services::geo::UniqueCategory>)
