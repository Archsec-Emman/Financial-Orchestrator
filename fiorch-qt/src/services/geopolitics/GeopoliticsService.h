...
class GeopoliticsService : public QObject
    , public fiorch::datahub::Producer
{
    Q_OBJECT
  public:
  ...
  signals:
    void events_loaded(fiorch::services::geo::EventsPage page);
    void countries_loaded(QVector<fiorch::services::geo::UniqueCountry> countries);
    void categories_loaded(QVector<fiorch::services::geo::UniqueCategory> categories);
    void cities_loaded(QStringList cities);
    void hdx_results_loaded(QString context, QVector<fiorch::services::geo::HDXDataset> datasets);
  ...
  private:
    ...
    void publish_hdx_result(const QString& context, const QVector<fiorch::services::geo::HDXDataset>& datasets);
