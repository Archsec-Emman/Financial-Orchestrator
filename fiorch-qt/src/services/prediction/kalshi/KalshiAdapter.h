...
class KalshiAdapter : public fiorch::services::prediction::PredictionExchangeAdapter {
    Q_OBJECT
  public:
  ...
  signals:
    ...
    void ws_trade_received(const fiorch::services::prediction::PredictionTrade& trade);
