...
namespace fiorch::services::prediction::kalshi_ns {
...
class KalshiRestClient : public QObject {
  ...
  signals:
    ...
    void order_book_ready(const fiorch::services::prediction::PredictionOrderBook& yes_book,
                          const fiorch::services::prediction::PredictionOrderBook& no_book,
                          const QString& ticker);
    void price_history_ready(const fiorch::services::prediction::PriceHistory& yes_history,
                             const QString& ticker);
    void trades_ready(const QVector<fiorch::services::prediction::PredictionTrade>& trades);
    ...
    void historical_markets_ready(
        const QVector<fiorch::services::prediction::PredictionMarket>& markets,
        const QString& next_cursor);
    void historical_candlesticks_ready(
        const fiorch::services::prediction::PriceHistory& history, const QString& ticker);
    void historical_trades_ready(
        const QVector<fiorch::services::prediction::PredictionTrade>& trades,
        const QString& next_cursor);
