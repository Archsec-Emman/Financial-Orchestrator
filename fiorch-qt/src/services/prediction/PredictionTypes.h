...
Q_DECLARE_METATYPE(fiorch::services::prediction::MarketKey)
Q_DECLARE_METATYPE(fiorch::services::prediction::PredictionMarket)
Q_DECLARE_METATYPE(fiorch::services::prediction::PredictionEvent)
Q_DECLARE_METATYPE(fiorch::services::prediction::PredictionOrderBook)
Q_DECLARE_METATYPE(fiorch::services::prediction::PriceHistory)
Q_DECLARE_METATYPE(fiorch::services::prediction::PredictionTrade)
Q_DECLARE_METATYPE(fiorch::services::prediction::PredictionPosition)
Q_DECLARE_METATYPE(fiorch::services::prediction::OpenOrder)
Q_DECLARE_METATYPE(fiorch::services::prediction::OrderResult)
Q_DECLARE_METATYPE(fiorch::services::prediction::AccountBalance)
Q_DECLARE_METATYPE(QVector<fiorch::services::prediction::PredictionMarket>)
Q_DECLARE_METATYPE(QVector<fiorch::services::prediction::PredictionEvent>)
Q_DECLARE_METATYPE(QVector<fiorch::services::prediction::PredictionTrade>)
Q_DECLARE_METATYPE(QVector<fiorch::services::prediction::PredictionPosition>)
Q_DECLARE_METATYPE(QVector<fiorch::services::prediction::OpenOrder>)
