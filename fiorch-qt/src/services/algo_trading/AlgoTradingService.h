...
class AlgoTradingService : public QObject {
  ...
  signals:
    ...
    void strategies_loaded(QVector<fiorch::services::algo::AlgoStrategy> strategies);
    void strategy_deleted(QString id);
    void deployment_started(QString deployment_id);
    void deployments_loaded(QVector<fiorch::services::algo::AlgoDeployment> deployments);
