...
namespace fiorch::trading::hyperliquid { class HyperliquidVenue; }
...
class AlphaArenaEngine : public QObject {
  ...
  private slots:
    void on_tick(fiorch::services::alpha_arena::Tick t);
  ...
  private:
    ...
    fiorch::trading::hyperliquid::HyperliquidVenue* hl_venue_ = nullptr;
