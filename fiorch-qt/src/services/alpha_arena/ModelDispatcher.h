...
namespace fiorch::services::alpha_arena {
...
class ModelDispatcher : public QObject {
  ...
  public slots:
    ...
    /// before this call.
    void dispatch_tick(fiorch::services::alpha_arena::Tick t,
                       fiorch::services::alpha_arena::TickContext ctx,
                       QHash<QString, fiorch::services::alpha_arena::AgentAccountState> per_agent_state,
                       std::optional<fiorch::services::alpha_arena::SituationalContext> situational);
  ...
  signals:
    ...
    void decision_received(QString decision_id, QString agent_id,
                           QVector<fiorch::services::alpha_arena::ProposedAction> actions,
                           QString parse_error);
