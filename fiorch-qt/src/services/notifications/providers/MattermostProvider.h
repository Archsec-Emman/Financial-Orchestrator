...
namespace fiorch::notifications {

class MattermostProvider final : public BaseProvider {
  public:
    QString provider_id() const override { return "mattermost"; }
    QString display_name() const override { return "Mattermost"; }
