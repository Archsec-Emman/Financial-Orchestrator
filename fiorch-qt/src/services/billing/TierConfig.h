...
struct TierConfig {
    ...
    static fiorch::wallet::TierStatus::Tier tier_from_weight(quint64 weight_raw) noexcept {
    ...
    static quint64 next_threshold_raw(fiorch::wallet::TierStatus::Tier current) noexcept {
        using Tier = fiorch::wallet::TierStatus::Tier;
        switch (current) {
    ...
    /// User-facing label.
    static QString label_for(fiorch::wallet::TierStatus::Tier t) {
        using Tier = fiorch::wallet::TierStatus::Tier;
        switch (t) {
    ...
    static QStringList features_unlocked_by(fiorch::wallet::TierStatus::Tier t) {
        using Tier = fiorch::wallet::TierStatus::Tier;
        switch (t) {
            case Tier::Free:
                return {};
