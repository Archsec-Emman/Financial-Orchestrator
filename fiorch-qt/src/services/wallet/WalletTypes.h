...
Q_DECLARE_METATYPE(fiorch::wallet::WalletBalance)
Q_DECLARE_METATYPE(fiorch::wallet::TokenHolding)
Q_DECLARE_METATYPE(fiorch::wallet::TokenPrice)
Q_DECLARE_METATYPE(fiorch::wallet::TokenMetadata)
Q_DECLARE_METATYPE(fiorch::wallet::ParsedActivity)
Q_DECLARE_METATYPE(QVector<fiorch::wallet::ParsedActivity>)
Q_DECLARE_METATYPE(fiorch::wallet::FncptDiscount)
Q_DECLARE_METATYPE(fiorch::wallet::BuybackEpoch)
Q_DECLARE_METATYPE(fiorch::wallet::BurnTotal)
Q_DECLARE_METATYPE(fiorch::wallet::SupplyHistoryPoint)
Q_DECLARE_METATYPE(QVector<fiorch::wallet::SupplyHistoryPoint>)
Q_DECLARE_METATYPE(fiorch::wallet::TreasuryReserves)
Q_DECLARE_METATYPE(fiorch::wallet::TreasuryRunway)
Q_DECLARE_METATYPE(fiorch::wallet::LockPosition)
Q_DECLARE_METATYPE(QVector<fiorch::wallet::LockPosition>)
Q_DECLARE_METATYPE(fiorch::wallet::VeFncptAggregate)
Q_DECLARE_METATYPE(fiorch::wallet::YieldSnapshot)
Q_DECLARE_METATYPE(fiorch::wallet::TreasuryRevenue)
Q_DECLARE_METATYPE(fiorch::wallet::TierStatus)
