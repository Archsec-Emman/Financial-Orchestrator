...
using namespace fiorch::services::maritime;
using namespace fiorch::screens::maritime_internal;
...
QWidget* MaritimeScreen::build_center_panel() {
    ...
    map_widget_ = new fiorch::ui::WorldMapWidget(splitter);
    ...
    map_loader_ = new fiorch::ui::LoadingOverlay(map_widget_);
    ...
    connect(map_widget_, &fiorch::ui::WorldMapWidget::pin_clicked, this, [this](int id) {
...
QWidget* MaritimeScreen::build_right_panel() {
    ...
    connect(imo_edit_, &QLineEdit::textChanged, this,
            [this](const QString&) { fiorch::ScreenStateManager::instance().notify_changed(this); });
