...
void ForumPostReaderPanel::build_ui() {
    ...
    auto* empty_page = new QWidget(this);
    ...
    // ── Page 2: content ───────────────────────────────────────────────────────
    content_page_ = new QWidget(this);
    ...
    auto* post_hdr = new QWidget(this);
    post_hdr->setStyleSheet(QString("background:qlineargradient(x1:0,y1:0,x2:0,y2:1,"
                                    "stop:0 %1,stop:1 %2);"
    ...
    title_label_->setStyleSheet(QString("color:%1;font-size:16px;font-weight:700;line-height:1.4;"
                                        "background:transparent;%2")
    ...
    auto* scroll_w = new QWidget(this);
    ...
    body_label_->setStyleSheet(QString("color:%1;font-size:13px;line-height:1.7;background:transparent;"
    ...
    // Comments area
    comments_area_ = new QWidget(this);
    comments_area_->setStyleSheet(QString("background:%1;").arg(ui::colors::BG_BASE()));
