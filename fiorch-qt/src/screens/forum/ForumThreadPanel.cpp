...
void ForumThreadPanel::build_ui() {
    ...
    auto* back_bar = new QWidget(this);
    ...
    auto* hdr_outer = new QWidget(this);
    hdr_outer->setStyleSheet(QString("background:qlineargradient(x1:0,y1:0,x2:0,y2:1,"
                                     "stop:0 %1,stop:1 %2);")
    ...
    auto* chip_row = new QWidget(this);
    ...
    // Gradient separator
    auto* hdr_sep = new QWidget(this);
    hdr_sep->setFixedHeight(2);
    hdr_sep->setStyleSheet(QString("background:qlineargradient(x1:0,y1:0,x2:1,y2:0,"
    ...
    auto* body_outer = new QWidget(this);
    ...
    t_body_lbl_->setStyleSheet(QString("color:%1;font-size:13px;line-height:1.8;background:transparent;"
                                       "padding:20px 32px;%2")
    ...
    auto* eng_outer = new QWidget(this);
    eng_outer->setFixedHeight(48);
    eng_outer->setStyleSheet(QString("background:%1;border-top:1px solid %2;"
                                     "border-bottom:1px solid %2;")
                                 .arg(ui::colors::BG_SURFACE(), ui::colors::BORDER_DIM()));
    auto* eng_outer_hl = new QHBoxLayout(eng_outer);
    eng_outer_hl->setContentsMargins(0, 0, 0, 0);

    auto* eng_w = new QWidget(this);
    ...
    auto* com_hdr_outer = new QWidget(this);
    ...
    auto* com_hdr_inner = new QWidget(this);
    ...
    auto* com_outer = new QWidget(this);
    ...
    t_comments_w_ = new QWidget(this);
    t_comments_w_->setMaximumWidth(860);
    t_comments_w_->setStyleSheet(QString("background:%1;").arg(ui::colors::BG_BASE()));
    ...
    auto* comp_accent = new QWidget(this);
    comp_accent->setFixedHeight(1);
    comp_accent->setStyleSheet(QString("background:qlineargradient(x1:0,y1:0,x2:1,y2:0,"
    ...
    auto* comp_inner = new QWidget(this);
...
void ForumThreadPanel::rebuild_comments() {
    ...
    for (int i = 0; i < current_.comments.size(); ++i) {
        ...
        // Thread accent line
        auto* tline = new QWidget(this);
        tline->setFixedSize(3, 22);
        tline->setStyleSheet(QString("background:%1;border-radius:1px;").arg(avc));
        ...
        clikes->setStyleSheet(QString("color:%1;font-size:10px;font-weight:600;"
                                      "background:transparent;%2")
        ...
        cbody->setStyleSheet(QString("color:%1;font-size:12px;line-height:1.6;"
        ...
        auto mk_act = [&](const QString& lbl, const QString& col, const QString& vt) {
            ...
            b->setStyleSheet(a ? QString("QPushButton{background:transparent;color:%1;"
