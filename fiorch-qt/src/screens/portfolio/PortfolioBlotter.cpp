...
static const char* const kColumnKeys[] = {
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "SYMBOL"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "QTY"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "LAST"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "AVG COST"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "MKT VAL"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "COST BASIS"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "P&L"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "P&L%"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "CHG%"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "TREND"),
    QT_TRANSLATE_NOOP("fiorch::screens::PortfolioBlotter", "WT%"),
};
