...
using fiorch::services::options::OISample;
using fiorch::services::options::OISnapshotter;
using fiorch::services::options::OptionChain;
using fiorch::services::options::OptionChainRow;
...
void MultiStraddleSubTab::unsubscribe_token(qint64 token) {
    ...
    if (!topic.isEmpty())
        fiorch::datahub::DataHub::instance().unsubscribe(this, topic);
