...
class OptionChainModel : public QAbstractTableModel {
  ...
  public:
    ...
    void set_chain(const fiorch::services::options::OptionChain& chain);
    ...
    void update_leg_quote(qint64 token, const fiorch::trading::BrokerQuote& q);

    const fiorch::services::options::OptionChain& chain() const { return chain_; }
