...
using fiorch::services::options::FiiDiiDay;
...
void FiiDiiSubTab::hideEvent(QHideEvent* e) {
    ...
    if (!subscribed_)
        return;
    fiorch::datahub::DataHub::instance().unsubscribe(this, kTopic);
    fiorch::datahub::DataHub::instance().unsubscribe_errors(this, kTopic);
    subscribed_ = false;
}

void FiiDiiSubTab::on_refresh_clicked() {
    fiorch::datahub::DataHub::instance().request(kTopic, /*force*/ true);
