...
class TemplatePickerPanel : public QWidget {
  ...
  signals:
    ...
    void template_chosen(const QString& template_id,
                         const fiorch::services::options::StrategyInstantiationOptions& options);
  ...
  private:
    void setup_ui();
    void rebuild_list_for_category(fiorch::services::options::StrategyCategory cat);
    void apply_template_to_controls(const fiorch::services::options::StrategyTemplate& tpl);

    fiorch::services::options::StrategyCategory active_category_ =
        fiorch::services::options::StrategyCategory::Bullish;
    ...
    const fiorch::services::options::StrategyTemplate* selected_ = nullptr;
};
