...
using fiorch::services::options::StrategyLeg;
using fiorch::trading::BasketMargin;
...
using fiorch::trading::OrderSide;
using fiorch::trading::OrderType;
using fiorch::trading::ProductType;
using fiorch::trading::UnifiedOrder;
