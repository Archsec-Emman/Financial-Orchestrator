...
class MultiStraddleSubTab : public QWidget {
  ...
  private:
    ...
    void rebuild_strike_combo(const fiorch::services::options::OptionChain& chain);
    ...
    fiorch::services::options::OptionChain last_chain_;
    ...
    QHash<qint64, QVector<fiorch::services::options::OISample>> samples_by_token_;
