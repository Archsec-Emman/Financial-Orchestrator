...
using namespace fiorch::trading;
using namespace fiorch::screens::crypto;
...
void CryptoTradingScreen::hub_subscribe_topics() {
    ...
    auto& session = fiorch::trading::ExchangeSessionManager::instance();
    ...
    connect(ws, &fiorch::trading::kraken::KrakenWsClient::ticker_received,
            ws_subscription_owner_, [self, primary](const fiorch::trading::TickerData& t) {
    ...
    connect(ws, &fiorch::trading::kraken::KrakenWsClient::orderbook_received,
            ws_subscription_owner_, [self](const fiorch::trading::OrderBookData& ob) {
    ...
    connect(ws, &fiorch::trading::kraken::KrakenWsClient::trade_received,
            ws_subscription_owner_, [self](const fiorch::trading::TradeData& td) {
    ...
    connect(ws, &fiorch::trading::kraken::KrakenWsClient::candle_received,
            ws_subscription_owner_,
            [self](const QString& sym, const QString& /*interval*/,
                   const fiorch::trading::Candle& c) {
