...
class StrategyListPanel : public QWidget {
  ...
  private slots:
    void on_strategies_loaded(QVector<fiorch::services::algo::AlgoStrategy> strategies);
  ...
  private:
    ...
    QVector<fiorch::services::algo::AlgoStrategy> strategies_;  // full list
    QVector<fiorch::services::algo::AlgoStrategy> filtered_;    // after search/sort
