...
void SurfaceAnalyticsScreen::on_vol_surface_received(const fiorch::DatabentoVolSurfaceResult& r) {
    if (data_inspector_)
...
void SurfaceAnalyticsScreen::on_ohlcv_received(const fiorch::DatabentoOhlcvResult& r) {
    if (data_inspector_) {
...
void SurfaceAnalyticsScreen::on_futures_received(const fiorch::DatabentoFuturesResult& r) {
    if (data_inspector_) {
...
void SurfaceAnalyticsScreen::on_surface_received(const fiorch::DatabentoSurfaceResult& r) {
    if (data_inspector_) {
