...
class SurfaceAnalyticsScreen : public QWidget,
                               public fiorch::screens::IStatefulScreen,
                               public fiorch::IGroupLinked {
    Q_OBJECT
    Q_INTERFACES(fiorch::IGroupLinked)
  public:
    ...
    void set_group(fiorch::SymbolGroup g) override { link_group_ = g; }
    fiorch::SymbolGroup group() const override { return link_group_; }
    void on_group_symbol_changed(const fiorch::SymbolRef& ref) override;
    fiorch::SymbolRef current_symbol() const override;
  ...
  private slots:
    ...
    void on_vol_surface_received(const fiorch::DatabentoVolSurfaceResult& r);
    void on_ohlcv_received(const fiorch::DatabentoOhlcvResult& r);
    void on_futures_received(const fiorch::DatabentoFuturesResult& r);
    void on_surface_received(const fiorch::DatabentoSurfaceResult& r);
  ...
  private:
    ...
    fiorch::SymbolGroup link_group_ = fiorch::SymbolGroup::None;
