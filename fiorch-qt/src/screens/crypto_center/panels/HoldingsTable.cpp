...
HoldingsTable::HoldingsTable(QWidget* parent) : QWidget(parent) {
    ...
    connect(&fiorch::wallet::TokenMetadataService::instance(),
            &fiorch::wallet::TokenMetadataService::metadata_changed, this,
...
void HoldingsTable::rebuild_table() {
    ...
    if (latest_balance_.sol_lamports > 0) {
        Row r;
        r.mint = QString::fromLatin1(fiorch::wallet::kWrappedSolMint);
