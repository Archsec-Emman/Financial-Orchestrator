...
class SwapPanel : public QWidget {
  ...
  private:
    ...
    const fiorch::wallet::TokenHolding* holding_for(const QString& mint) const;
    ...
    mutable fiorch::wallet::TokenHolding sol_holding_;
    ...
    fiorch::wallet::WalletBalance latest_balance_;
    QString from_mint_;
    QString to_mint_;
