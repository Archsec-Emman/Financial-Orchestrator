...
class CrashRecoveryDialog : public QDialog {
  ...
  public:
    ...
    explicit CrashRecoveryDialog(fiorch::CrashRecovery* recovery,
                                 fiorch::WorkspaceSnapshotRing* ring,
  ...
  private:
    ...
    QString display_name(const fiorch::WorkspaceSnapshotRing::Entry& e) const;

    fiorch::CrashRecovery* recovery_ = nullptr;
    fiorch::WorkspaceSnapshotRing* ring_ = nullptr;
    ...
    QList<fiorch::WorkspaceSnapshotRing::Entry> entries_;
