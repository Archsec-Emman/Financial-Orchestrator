...
class HDXDataPanel : public QWidget {
  ...
  private slots:
    void on_hdx_results(const QString& context, QVector<fiorch::services::geo::HDXDataset> datasets);
    void on_view_changed(int index);

  private:
    void build_ui();
    void connect_service();
    void populate_table(const QVector<fiorch::services::geo::HDXDataset>& datasets);
    ...
    QVector<fiorch::services::geo::HDXDataset> cache_conflicts_;
    QVector<fiorch::services::geo::HDXDataset> cache_humanitarian_;
    QVector<fiorch::services::geo::HDXDataset> cache_datasets_;
};
