...
class ConflictMonitorPanel : public QWidget {
  ...
  public:
    ...
    void set_events(const QVector<fiorch::services::geo::NewsEvent>& events);
  ...
  private:
    ...
    void update_stats(const QVector<fiorch::services::geo::NewsEvent>& events);
    void update_hotspots(const QVector<fiorch::services::geo::NewsEvent>& events);
    void update_map(const QVector<fiorch::services::geo::NewsEvent>& events);

    // Map
    fiorch::ui::WorldMapWidget* map_widget_ = nullptr;
