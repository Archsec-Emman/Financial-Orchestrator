...
QWidget* ProfileScreen::build_support() {
    ...
    make_link_btn(tr("DOCS"), "https://github.com/Archsec-Emman/FinancialOrchestrator/tree/main/docs");
    make_link_btn(QStringLiteral("GITHUB"), "https://github.com/Archsec-Emman/FinancialOrchestrator");
    make_link_btn(QStringLiteral("DISCORD"), "https://discord.gg/ae87a8ygbN");
    make_link_btn(tr("FAQ"), "https://github.com/Archsec-Emman/FinancialOrchestrator/wiki");
    lrl->addStretch();
    lvl->addWidget(lr);
    vl->addWidget(lp);
    vl->addStretch();
