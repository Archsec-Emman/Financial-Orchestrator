...
using fiorch::services::alpha_arena::AgentSpec;
using fiorch::services::alpha_arena::AlphaArenaEngine;
using fiorch::services::alpha_arena::CompetitionMode;
using fiorch::services::alpha_arena::NewCompetitionConfig;
using fiorch::services::alpha_arena::kPerpUniverse;
...
void AlphaArenaScreen::on_live_mode_toggle_clicked() {
    ...
    if (!fiorch::trading::hyperliquid::HyperliquidSigner::is_wired()) {
        QMessageBox::critical(this, tr("Alpha Arena"),
...
#ifndef FIORCH_UNSAFE_DISABLE_GEOFENCE
