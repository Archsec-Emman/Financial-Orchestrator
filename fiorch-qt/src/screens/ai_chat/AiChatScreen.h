...
class AiChatScreen : public QWidget, public IStatefulScreen, public fiorch::IGroupLinked {
    Q_OBJECT
  ...
  public:
    ...
    void set_group(fiorch::SymbolGroup g) override;
    ...
    fiorch::SymbolRef current_symbol() const override { return linked_symbol_; }
  ...
  private:
    ...
    fiorch::SymbolRef linked_symbol_;
};
