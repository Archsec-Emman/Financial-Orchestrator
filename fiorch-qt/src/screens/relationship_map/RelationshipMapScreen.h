...
class RelationshipMapScreen : public QWidget, public IStatefulScreen {
  ...
  private:
    ...
    void on_asset_results(const QList<fiorch::services::MarketSearchService::Item>& results);
    void show_dropdown();
    void hide_dropdown();
    void on_data_ready(const fiorch::relmap::RelationshipData& data);
