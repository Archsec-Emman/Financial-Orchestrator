...
TermsScreen::TermsScreen(QWidget* parent) : QWidget(parent) {
    ...
    pvl->addWidget(body_text("By accessing or using Financial Orchestrator (\"the Service\"), you agree to be bound by these "
                             "Terms of Service. If you do not agree to these terms, do not use the Service."));

    // Section 2
    pvl->addWidget(section_heading("2", "DESCRIPTION OF SERVICE"));
    pvl->addWidget(body_text("Financial Orchestrator is a desktop financial intelligence terminal providing market data, "
