...
class EquitySentimentTab : public QWidget {
  ...
  private slots:
    void on_snapshot_loaded(QString symbol, fiorch::services::equity::MarketSentimentSnapshot snapshot);

  private:
    void build_ui();
    void retranslateUi();
    void populate(const fiorch::services::equity::MarketSentimentSnapshot& snapshot);
    void clear_sources();
    ...
    fiorch::services::equity::MarketSentimentSnapshot cached_snapshot_;
