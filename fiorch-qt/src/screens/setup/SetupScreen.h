...
class SetupScreen : public QWidget {
  ...
  private slots:
    void on_begin_setup();
    void on_progress(const fiorch::python::SetupProgress& progress);
  ...
  private:
    ...
    fiorch::ui::SpeedSparkline* sparkline_ = nullptr;
    fiorch::net::NetSpeedMeter* net_meter_ = nullptr;
