...
// recent files) lives in fiorch::services::ReportBuilderService. This
...
// originally written against types declared inside fiorch::screens. After
...
using ReportComponent = ::fiorch::report::ReportComponent;
using ReportMetadata = ::fiorch::report::ReportMetadata;
using ReportTheme = ::fiorch::report::ReportTheme;
