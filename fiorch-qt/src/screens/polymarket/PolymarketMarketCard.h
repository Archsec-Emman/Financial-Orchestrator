...
class PolymarketMarketCardModel : public QAbstractListModel {
  ...
  public:
    ...
    void set_markets(const QVector<fiorch::services::prediction::PredictionMarket>& markets);
    void set_events(const QVector<fiorch::services::prediction::PredictionEvent>& events);
    ...
    bool update_market(const fiorch::services::prediction::PredictionMarket& market);

    const fiorch::services::prediction::PredictionMarket* market_at(int row) const;
    const fiorch::services::prediction::PredictionEvent* event_at(int row) const;
    const ExchangePresentation& presentation() const { return presentation_; }

  private:
    QVector<fiorch::services::prediction::PredictionMarket> markets_;
    QVector<fiorch::services::prediction::PredictionEvent> events_;
