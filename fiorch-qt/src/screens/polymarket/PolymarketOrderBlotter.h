...
class PolymarketOrderBlotter : public QWidget {
  ...
  public:
    ...
    void set_orders(const QVector<fiorch::services::prediction::OpenOrder>& orders);
    ...
    void update_order(const fiorch::services::prediction::OpenOrder& order);
    void clear();
  ...
  private:
    void rebuild_rows();
    void install_row_controls(int row, const fiorch::services::prediction::OpenOrder& order);

    QTableWidget* table_ = nullptr;
    QVector<fiorch::services::prediction::OpenOrder> orders_;
