...
class PolymarketOrderBook : public QWidget {
  ...
  public:
    ...
    void set_data(const fiorch::services::prediction::PredictionOrderBook& book);
    void clear();
  ...
  private:
    ...
    QVector<fiorch::services::prediction::OrderLevel> bids_;
    QVector<fiorch::services::prediction::OrderLevel> asks_;
    double spread_ = 0.0;
    QMutex mutex_;
    QPixmap cache_;
