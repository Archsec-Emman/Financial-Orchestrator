...
struct ExchangePresentation {
    ...
    StatusBadge status_badge(const fiorch::services::prediction::PredictionMarket& market) const;

    // Factories.
    static ExchangePresentation for_polymarket();
    static ExchangePresentation for_kalshi();
    static ExchangePresentation for_adapter(const fiorch::services::prediction::PredictionExchangeAdapter* adapter);
