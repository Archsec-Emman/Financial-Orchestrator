...
class PolymarketDetailPanel : public QWidget {
  ...
  public:
    ...
    void set_market(const fiorch::services::prediction::PredictionMarket& market);
    void set_order_book(const fiorch::services::prediction::PredictionOrderBook& book);
    void set_price_history(const fiorch::services::prediction::PriceHistory& history);
    void set_trades(const QVector<fiorch::services::prediction::PredictionTrade>& trades);

    // Trading ticket setters — wired from adapter balance_ready / positions_ready.
    void set_balance(const fiorch::services::prediction::AccountBalance& balance);
    void set_positions(const QVector<fiorch::services::prediction::PredictionPosition>& positions);
    void on_order_result(const fiorch::services::prediction::OrderResult& result);
    ...
    void set_price_summary(const fiorch::services::polymarket::PriceSummary& summary);
    void set_top_holders(const QVector<fiorch::services::polymarket::TopHolder>& holders);
    void set_comments(const QVector<fiorch::services::polymarket::Comment>& comments);
    void set_related_markets(const QVector<fiorch::services::prediction::PredictionMarket>& markets);
  ...
  signals:
    ...
    void related_market_clicked(const fiorch::services::prediction::PredictionMarket& market);
    void place_order(const fiorch::services::prediction::OrderRequest& req);
  ...
  private:
    ...
    void render_status_badge(const fiorch::services::prediction::PredictionMarket& market);
    ...
    fiorch::services::prediction::PredictionMarket last_market_;
