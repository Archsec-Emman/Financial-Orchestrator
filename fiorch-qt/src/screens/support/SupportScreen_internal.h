...
namespace fiorch::screens::support_internal {
...
inline QString SS_INPUT() {
    return QString("QLineEdit, QTextEdit, QComboBox {"
        ...
        .arg(fiorch::ui::colors::BG_SURFACE(), fiorch::ui::colors::TEXT_PRIMARY(),
             fiorch::ui::colors::BORDER_MED(), MF, fiorch::ui::colors::AMBER(),
             fiorch::ui::colors::BG_RAISED(), fiorch::ui::colors::BG_BASE());
}
...
inline QString SS_BTN_PRIMARY() {
    return QString("QPushButton { background: %1; color: %2; border: none;"
        ...
        .arg(fiorch::ui::colors::AMBER(), fiorch::ui::colors::BG_BASE(), MF,
             fiorch::ui::colors::AMBER_DIM(), "#92400e",
             fiorch::ui::colors::BORDER_MED(), fiorch::ui::colors::TEXT_DIM());
}
...
inline QString SS_BTN_SUCCESS() {
    return QString("QPushButton { background: %1; color: %2; border: none;"
        ...
        .arg(fiorch::ui::colors::POSITIVE(), fiorch::ui::colors::BG_BASE(), MF,
             fiorch::ui::colors::BORDER_MED(), fiorch::ui::colors::TEXT_DIM());
}
...
inline QString SS_BTN_DANGER() {
    return QString("QPushButton { background: transparent; color: %1; border: 1px solid %1;"
        ...
        .arg(fiorch::ui::colors::NEGATIVE(), MF, fiorch::ui::colors::BG_BASE(),
             fiorch::ui::colors::TEXT_DIM());
}
...
inline QString SS_BTN_OUTLINE() {
    return QString("QPushButton { background: transparent; color: %1; border: 1px solid %1;"
                   ...
                   "QPushButton:hover { background: %1; color: %3; }"
                   "QPushButton:disabled { border-color: %4; color: %4; }")
        .arg(fiorch::ui::colors::POSITIVE(), MF, fiorch::ui::colors::BG_BASE(),
             fiorch::ui::colors::TEXT_DIM());
}
...
inline QString SS_BTN_GHOST() {
    return QString("QPushButton { background: transparent; color: %1; border: 1px solid %2;"
                   ...
                   "QPushButton:pressed { background: %5; }")
        .arg(fiorch::ui::colors::TEXT_SECONDARY(), fiorch::ui::colors::BORDER_MED(), MF,
             fiorch::ui::colors::TEXT_PRIMARY(), fiorch::ui::colors::BORDER_DIM());
}
...
inline QFrame* hsep() {
    ...
    f->setFixedHeight(1);
    f->setStyleSheet(QString("background:%1;border:none;").arg(fiorch::ui::colors::BORDER_DIM()));
    return f;
}
