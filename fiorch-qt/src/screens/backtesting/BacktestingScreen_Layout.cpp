...
using namespace fiorch::services::backtest;
using fiorch::screens::backtesting_internal::pill_qss;
using fiorch::screens::backtesting_internal::apply_pill_geometry;
