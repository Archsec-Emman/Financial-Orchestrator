...
using fiorch::screens::docs_internal::SCROLL_SS;
...
QWidget* DocsScreen::page_welcome() {
    ...
    vl->addWidget(
        make_section_panel("■", "WHAT IS FINCEPT TERMINAL?",
                           "Financial Orchestrator is a professional-grade desktop financial intelligence platform "
                           ...
                           "and support for 15+ broker integrations, Financial Orchestrator bridges the gap between "
...
QWidget* DocsScreen::page_getting_started() {
    ...
    vl->addWidget(make_muted_label("Your first steps with Financial Orchestrator"));
    ...
    vl->addWidget(make_section_panel("1", "LAUNCH & LOGIN",
                                     "When you first launch Financial Orchestrator, you'll see the login screen. "
                                     "You can either:\n\n"
    ...
    vl->addWidget(make_section_panel("4", "SUBSCRIPTION PLANS",
                                     "Financial Orchestrator offers tiered access:\n\n"
