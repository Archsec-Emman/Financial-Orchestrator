...
using fiorch::services::ma::MAAnalyticsService;
...
class MAModulePanel : public QWidget {
    Q_OBJECT
  public:
    explicit MAModulePanel(const fiorch::services::ma::ModuleInfo& info, QWidget* parent = nullptr);
  ...
  private:
    ...
    fiorch::services::ma::ModuleInfo module_;
