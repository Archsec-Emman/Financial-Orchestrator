...
inline ReportTheme by_name(const QString& name) {
    ...
    if (name == "Financial Orchestrator")
...
inline QStringList all_names() {
    return {"Light Professional", "Dark Corporate", "Financial Orchestrator", "Midnight Blue"};
}
