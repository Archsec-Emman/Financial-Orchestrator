...
class SymbolContext : public QObject {
  ...
  signals:
    ...
    void group_symbol_changed(fiorch::SymbolGroup g, fiorch::SymbolRef ref, QObject* source);
    ...
    void group_slot_symbol_changed(fiorch::SymbolGroup g, QString slot,
                                   fiorch::SymbolRef ref, QObject* source);

    void active_symbol_changed(fiorch::SymbolRef ref, QObject* source);
