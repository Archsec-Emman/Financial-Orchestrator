...
echo ""
echo "================================================"
echo "  Financial Orchestrator v4.0.1 — Setup"
...
APP_DIR="$SCRIPT_DIR/fiorch-qt"
[ -d "$APP_DIR" ] || fail "fiorch-qt directory not found. Ensure you cloned the full repository."
cd "$APP_DIR"
...
# ── Done ────────────────────────────────────────────────────
BIN="$APP_DIR/build/$PRESET/FinancialOrchestrator"
[ "$PLATFORM" = "macos" ] && BIN="$APP_DIR/build/$PRESET/FinancialOrchestrator.app/Contents/MacOS/FinancialOrchestrator"
